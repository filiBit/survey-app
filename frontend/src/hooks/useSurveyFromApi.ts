...
import { Api, ApiErrorsResponse, ApiGetResponse, Survey } from '../../models'

export function useSurveyFromApi({ api, survey, errorResponse, setErrorResponse, setSurvey }: HookParameters) {
  useEffect(() => {
